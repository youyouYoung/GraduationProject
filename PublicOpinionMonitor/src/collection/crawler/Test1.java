...
public class Test1
{
	...
	public Test1(String url)
	{
		...
		try
		{
			tempFile = File.createTempFile("orign", "mxa");
			tempFile1 = File.createTempFile("change", ".tmp");
			bufw = new BufferedWriter(new FileWriter(tempFile));
			bufw1 = new BufferedWriter(new FileWriter(tempFile1));
		}
		catch (IOException e)
		{
	...
	public void addOrignData(String line)
	{
		try
		{
			bufw.write(line);
	...
	public void addChageData(String line)
	{
		try
		{
			bufw1.write(line);
